<?php
    class AjaxController extends Controller {
        ...
        public function actionBairro()
        {
            ...
            $tmp = Imovel::model()->model()->findAll( array('condition' => 'finalidade = "'.$_POST['finalidade'].'" AND uf = "SC" AND cidade = "'.$_POST['cidade'].'"', 'group' => 'bairro') );
            if( count($tmp) == 0 ){
        ...
        public function actionTipo()
        {
            ...
            && isset($_POST['bairro']) ) {
                ...
                $tmp = Imovel::model()->model()->findAll( array('condition' => 'finalidade = "'.$_POST['finalidade'].'" AND uf = "SC" AND cidade = "'.$_POST['cidade'].'" AND bairro = "'.$_POST['bairro'].'"', 
                                                'group' => 'tp_bem') );
                if( count($tmp) == 0 ){
