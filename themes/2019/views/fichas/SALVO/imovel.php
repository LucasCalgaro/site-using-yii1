...
<div class="col-md-9 contato">
    ...
    <?
        ...
        echo '
            '.$form->hiddenField($model, 'titulo12').'
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <h2 class="col-md-12">DADOS DO IMÓVEL</h2>
            ...
            <div class="row">
                <h2 class="col-md-12">AVALIAÇÃO DO IMÓVEL</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    '.$form->labelEx($model,'terreno').$form->dropDownList($model, 'terreno', Yii::app()->util->selectOpcao('terreno'), array('class' => 'col-md-12', 'empty' =>'Selecione um estado')).'
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="well marginTop">
                        <p>1. Não Tratar de locação e/ou venda diretamente ou por intermédio de outrem durante o prazo de vigência desta opção;</p>
                        <p>2. Após o vencimento do prazo de vigência desta, ocorrendo a hipótese de se efetivar a transação com pessoa indicada pela empresa contratada, ou corretor, dentro do prazo de vigência desta, a remuneração constante no quadro acima, Taxa de locação de _____% do valor do 1º Aluguel, com validade de 1 (um) ano, o enquanto perdurar o contrato de locação, e taxa de administração de ______% ao mês sobre o valor do aluguel, enquanto perdurar o contrato de locação, ou ________% do valor da venda do imóvel em caso venda do mesmo;</p>
                        <p>3. A referendar qualquer locação feita dentro das condições mínimas acima especificadas, bem como dar por firme e valioso qualquer contrato de locação e/ou venda pactuado, que a empresa acima fica desde já expressamente autorizada a receber e do mesmo modo passar recibo em seu nome;</p>
                        <p>4. A Contratada obriga-se a prestar seus serviços com zelo e solicitude, podendo anunciar a Locação e/ou venda do imóvel,correndo todas as despesas por sua e própria custa.</p>
                    </div>
                </div>
            </div>
